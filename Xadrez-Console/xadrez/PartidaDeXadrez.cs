    ...
    class PartidaDeXadrez
    {
        ...
        public void realizaJogada(Posicao origem, Posicao destino)
        {
            ...
            if (estaEmXeque(jogadorAtual))
            {
                ...
                throw new TabuleiroExeception("Você nao pode se colocar em xeque!");
            }
            Peca p = tab.peca(destino);

            //#jogada espcial promocao
            if(p is Peao)
            {
        ...
        public void validarPosicaoDeOrigem(Posicao pos)
        {
            ...
            {
                throw new TabuleiroExeception("Não há movimentos possíveis para a peça escolhida!");
            }
        }   
